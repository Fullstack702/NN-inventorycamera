...
const _VIA_ATTRIBUTE_ANCHOR = {
  ...
  FILE1_Z1_XY1:
    "Spatial Region in a Video Frame (e.g. bounding box of an object)",
  FILE1_Z1_XYN: "__FUTURE__", // A video frame region composed of multiple disconnected regions
  FILE1_Z2_XY0:
    "Temporal Segment in Video or Audio (e.g. video segment containing an actor)",
  ...
  FILEN_Z0_XY0:
    "Attribute of a Group of Files (e.g. given two images, which is more sharp?)",
